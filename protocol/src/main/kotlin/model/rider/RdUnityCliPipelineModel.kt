...
@Suppress("unused")
object RdUnityCliPipelineModel : Ext(SolutionModel.Solution) {
    ...
    init {
        setting(Kotlin11Generator.Namespace, "com.jetbrains.rider.plugins.unityclipipeline.model")
        setting(CSharp50Generator.Namespace, "Rider.Plugins.UnityCliPipeline.Model")
