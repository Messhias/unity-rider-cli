package com.jetbrains.rider.plugins.unityclipipeline
...
import com.jetbrains.rider.plugins.unityclipipeline.model.RdCallRequest
import com.jetbrains.rider.plugins.unityclipipeline.model.rdUnityCliPipelineModel
...
class ProtocolCaller(private val project: Project) {
    ...
    suspend fun doCall(input: String): Int {
        val model = project.solution.rdUnityCliPipelineModel
